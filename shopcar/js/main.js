...
(function() {
    ...
    function sliderTo(prev, next) {
        ...
        var liObj = document.querySelectorAll('.circle li')
        liObj[prev].className = 'blur';
        liObj[next].className = 'focus'
...
$("#datas").on("click",".img-fluid",function(){
    var goodsId=$(this).attr("gd")
